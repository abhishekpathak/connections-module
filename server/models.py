...
class UsersRepository(ABC):
    """ provides a contract that any ORM must implement to persist Users
...
class ConnectionsRepository(ABC):
    """ provides a contract that any ORM must implement to Connections
...
class RecommendationsRepository(ABC):
    """ provides a contract that any ORM must implement to persist Recommendations
